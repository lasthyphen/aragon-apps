...
var DIJETS_WALLET_BASE_URL = 'https://whitelist.dijets.io';
var TRUST_WALLET_BASE_URL = 'https://raw.githubusercontent.com/trustwallet/assets/master/blockchains/ethereum';
var ETHERSCAN_URL = 'http://20.9.33.115:4000';
var LOWERSCAN_URL = 'http://20.9.33.115:4000/';
var POLYGON_URL = 'polygonscan.com';
var NETWORK_TYPES_URLS = new Map([['dijets', ETHERSCAN_URL], ['main', LOWERSCAN_URL], ['kovan', "kovan.".concat(ETHERSCAN_URL)], ['rinkeby', "rinkeby.".concat(ETHERSCAN_URL)], ['ropsten', "ropsten.".concat(ETHERSCAN_URL)], ['goerli', "goerli.".concat(ETHERSCAN_URL)], ['matic', POLYGON_URL], ['mumbai', "mumbai.".concat(POLYGON_URL)], ['harmony', "explorer.harmony.one"], ['harmonyTest', "explorer.pops.one"]]);
...
function _getBlockExplorer(_ref) {
  ...
  return "http://".concat(subdomain, "/").concat(typePart, "/").concat(value);
}
/**
...
function blockExplorerUrl(type, value) {
  var _ref2 = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : {},
      ...
      networkType = _ref2$networkType === void 0 ? 'dijets' : _ref2$networkType;
...
function tokenIconUrl() {
  ...
  if (address === EMPTY_ADDRESS) {
    return "".concat(DIJETS_WALLET_BASE_URL, "/dijets.png");
  }
...
//# sourceMappingURL=web3-a93affd5.js.map
